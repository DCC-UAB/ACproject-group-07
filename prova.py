# -*- coding: utf-8 -*-
"""
Created on Fri Nov 29 17:49:29 2024
        ...
        for i in range(n_prev_games, len(player_data)):
            ...
            for game_idx, game in enumerate(last_games.itertuples(), start=1):
                for col in feature_columns:
                    X[f'{col}game{game_idx}'] = getattr(game, col)
...
n_prev_games_list = [15] #despres fer per 5 i 10
...
results.to_csv('model_evaluation_results_15.csv', index=False)
